...
Supayan_photo = fr.load_image_file('photos/Supayan.jpg')
Supayan_encoding = fr.face_encodings(Supayan_photo)[0]

Subhannita_photo = fr.load_image_file('photos/Subhannita.jpg')
Subhannita_encoding = fr.face_encodings(Subhannita_photo)[0]

hissen_photo = fr.load_image_file('photos/hissen.jpg')
hissen_encoding = fr.face_encodings(hissen_photo)[0]

tiago_photo = fr.load_image_file('photos/tiago.jpg')
tiago_encoding  = fr.face_encodings(tiago_photo)[0]

Suhena_photo = fr.load_image_file('photos/Suhena.jpg')
Suhena_encoding  = fr.face_encodings(Suhena_photo)[0]
